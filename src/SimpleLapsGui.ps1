...
2025-12-10 / v1.3m / htcfreek / Main UI redisign; Multi domain support; Zoom dialog for bigger crdential preview; Set time dialog now respects system's format settings.; Support for ESCAPE key in time dialog and about dialog.; Fixed dpi scaling bug in about dialog.; Improved window sizing with dpi scaling.; Don't provide AutoIT-Exe-Wrapper version anymore.; Various improvements.
