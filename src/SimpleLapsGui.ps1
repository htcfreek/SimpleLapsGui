...
function GetPassword
{
    ...
    try
    {
        if ($null -eq $Script:selectedComputerDomain) {
           #$pwds = Get-LapsADPassword -Identity "$($Script:selectedComputer)" -AsPlainText -IncludeHistory -ErrorAction Stop -WarningAction SilentlyContinue | Select-Object ComputerName,Account,Password,PasswordUpdateTime,ExpirationTimestamp
        }
        else {
            #$pwds = Get-LapsADPassword -Identity "$($Script:selectedComputer)" -Domain "$($Script:selectedComputerDomain)" -AsPlainText -IncludeHistory -ErrorAction Stop -WarningAction SilentlyContinue | Select-Object ComputerName,Account,Password,PasswordUpdateTime,ExpirationTimestamp
        }
        $pwds = @([pscustomobject] @{
           ...
           # Execute
            if ($script:winLapsComputer) {
                ...
                if (![string]::IsNullOrWhiteSpace($Script:selectedComputerDomain)) {
                    # custom domain
                    Set-LapsADPasswordExpirationTime -Identity $Script:selectedComputer -Domain $Script:selectedComputerDomain -WhenEffective $newExpTime -ErrorAction Stop -WarningAction SilentlyContinue
                }
                else {
                    # defautl domain
...
$AccountNameData.Location = New-Object System.Drawing.Point(100,114)
$AccountNameData.Size = New-Object System.Drawing.Point(300,20)
...
$PasswordData.Location = New-Object System.Drawing.Point(100,142)
$PasswordData.Size = New-Object System.Drawing.Point(300,20)
...
$PasswordCopyButton.Add_Click({Set-Clipboard $PasswordData.Text})
$PasswordCopyButton.Hide()
...
$ExpirationTimeData.Location = New-Object System.Drawing.Point(100,168)
$ExpirationTimeData.Size = New-Object System.Drawing.Point(150,20)
