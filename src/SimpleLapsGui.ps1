...
function GetPassword
{
    ...
    $Script:winLapsComputer = $pwds[0].PasswordUpdateTime -ne $null
...
$aboutFormRepoLink.Location = "110, 105"
...
$aboutFormAuthorLink.Location = "110, 125"
